...
I have software related experience in both teaching and research. I have served as a teaching assistant for multiple classes requiring programming and I am currently scheduled to teach a "Computer Programming for Mechanical Systems" course at Oregon State University in the winter 2021 term. My research also provides me with software experience as it requires that I implement new functionality in an open-source chemical kinetics package called Cantera. My day to day revolves mostly around the use of C++, Python, and Bash but I have used many languages which can be found on my resume, ranked by experience. Similarly, my Master's project was the implementation of heterogeneous communication avoidance algorithms for accelerating simulations on distributed systems. To this end, I used a number of languages and software packages listed on my resume. Finally, I have sought personal projects/tutorials which have extended my skill set into various fields such as cybersecurity, application development, and web development. 

In conclusion, I have a diverse skill set that aligns well with this position. I have an affinity for all aspects of computer science which is well suited to any area in scientific computing. Finally, I am an avid learner and any of the skills that I do not already have can be efficiently developed to meet the needs of the project that I am working on.
