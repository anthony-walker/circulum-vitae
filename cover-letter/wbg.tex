...
My name is Anthony Walker. I am a mechanical engineering Ph.D., software engineer III and open source software developer.
I am interested in a several of the part time teaching positions available.
...
I have served as a teaching assistant for multiple classes in the mechanical engineering department and instructor for "Computer Programming for Mechanical Systems" course at Oregon State University.
My research required that I implement new functionality in an open-source chemical kinetics package called Cantera.
My day to day work as a software engineer requires the use of C++, Python, and Bash to develop, implement, and test numerical techniques as well as apply them to physical problems.
...
In conclusion, I have a diverse skill set that aligns well with several of the teaching positions.
I have worked in collaboration with others on real and practical open-source software used to model chemistry, fluid mechanics, nuclear physics, material integrity, etc.
