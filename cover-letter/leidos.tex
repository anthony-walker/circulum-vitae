...
My name is Anthony Walker and I am a fourth year PhD student at Oregon State University and I am interested in the High performance computing internship. 
...
My day to day requires the use of C++, Python, and Bash to develop, implement, and test numerical techniques as well as apply them to physical problems in thermal fluid sciences and combustion. 

Similarly, my Master's project required the implementation of techniques to accelerate simulations of
multi-physics problems in multiple dimensions such as compressible fluid flow. 
...
All of the code to implement and study these techniques was developed from scratch and is openly available on my github.

In conclusion, I have a diverse skill set that aligns perfectly with the high performance computing internship. 
I have researched, developed, and implemented advanced techniques to accelerate simulation reacting flows.
I have worked in collaboration with others on real and practical open-source software used to model chemistry, thermodynamics, and transport. 
