...
\newcommand{\position}{Engineering Intern}
...
My name is Anthony Walker and I am a fourth year PhD student at Oregon State University and I am interested in the \position{} position at Gitlab. I am qualified for this position because I have a wide breadth of experience in computer science and software development.
My degree is nominally in mechanical engineering but my work is a combination of computer science, software development, physics, mathematics, etc.

I have software related experience in both teaching and research. I have assisted multiple professors in teaching programming related courses and I am currently teaching a "Computer Programming for Mechanical Systems" course at Oregon State University. My research also provides me with software experience as it requires that I implement new functionality in an open-source chemical kinetics package called Cantera. In my daily work I mostly use of C++, Python, and Bash but I have used many languages, tools, and frameworks which can be found on my resume, ranked by experience. 

Similarly, my Master's project was the implementation of heterogeneous communication avoidance algorithms for accelerating simulations on distributed systems which required the use of many software skills and tools. I have sought personal projects which have extended my skills into various fields such as cybersecurity and web development.

In conclusion, I have a diverse skill set that aligns well with any engineering and software development related position. I have an affinity for all aspects of computer science which is well suited to multiple areas in computing and computer science. Finally, I am an avid learner and any of the skills that I do not already have can be efficiently developed to meet the needs of the project that I am working on.
